...
$(window.document).ready(() => {
	...
	function initEvents() {
		...
		$( "#dropdown" )
			.change(function () {
			console.log("allaus")
			var allausLayer = new Cesium.WebMapServiceImageryProvider({
			...
			$("select option:allausLayer" ).each(function() {
				console.log("allausss")
				viewer.imageryLayers.addImageryProvider(allausLayer);
			});
		});
...
;
	...
	//LAYERS
		$("#allausLayer").on("click", () => {
			console.log("entroallaus")
